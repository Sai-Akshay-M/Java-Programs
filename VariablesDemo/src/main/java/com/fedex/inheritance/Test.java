...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Manager manager = new Manager(10,"Akshay","Travel",1000000,projects);
        ...
        Developer developer = new Developer(01, "Mopuru","Travel", 2000000 ,"Java Development");
        ...
        Tester tester = new Tester(02,"Chaitanya","Travel", 2000000, tools);
